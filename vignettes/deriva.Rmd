...
The detector correctly identifies the distributional change shortly after the known drift point (observation 500), with no false alarms in the 500 stable observations before it.
